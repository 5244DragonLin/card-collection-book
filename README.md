...
- **拼图预览**：支持 3×3 拼图卡一键合成预览（哆啦A梦、三国志8 REMAKE 等 IP 的 TR 拼图卡），点击弹窗中的拼图块可无缝跳转到对应卡牌的长廊位置
...
- **新增：** 拼图预览——TR 拼图卡一键 3×3 合成预览，支持多组拼图切换（左右箭头 + 键盘），点击弹窗中的拼图块无缝跳转到对应卡牌的长廊位置
- **新增：** 全屏预览大图支持键盘左右方向键切换上一张/下一张，Esc 关闭
